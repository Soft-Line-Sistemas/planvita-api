...
exports.CorresponsavelController = void 0;
const corresponsavel_service_1 = require("../services/corresponsavel.service");
const logger_1 = __importDefault(require("../utils/logger"));
class CorresponsavelController {
    constructor() {
        this.logger = new logger_1.default({ service: 'CorresponsavelController' });
    }
    async getAll(req, res) {
        try {
            if (!req.tenantId)
                return res.status(400).json({ message: 'Tenant unknown' });
            const service = new corresponsavel_service_1.CorresponsavelService(req.tenantId);
...
exports.CorresponsavelController = CorresponsavelController;
