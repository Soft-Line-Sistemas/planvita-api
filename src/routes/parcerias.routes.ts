...
router.get('/cliente/categorias', authenticateCliente, controller.listarCategoriasCliente.bind(controller));
router.get('/cliente/vantagens', authenticateCliente, controller.listarVantagensCliente.bind(controller));
router.get('/cliente/vantagens/:slug', authenticateCliente, controller.obterVantagemCliente.bind(controller));
router.post('/cliente/vantagens/:id/resgates', authenticateCliente, controller.registrarResgate.bind(controller));
